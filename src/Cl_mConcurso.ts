...
export default class Cl_mConcurso {
    private listaAspirantes: Cl_mParticipante[] = [];
    ...
    calcularResultadosFinales(): Cl_mParticipante[] {
        ...
        const aspirantesOrdenados = this.listaAspirantes.sort((a, b) => 
    ...
    obtenerGanadorConcurso(): Cl_mParticipante | null {
        if (this.listaAspirantes.length === 0) return null;
    ...
    eliminarAspiranteConcurso(id: number): boolean {
